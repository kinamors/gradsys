...
<div class="container-fluid">
        ...
        <div class="col-md-8">
            <form class="form-horizontal" id="updatePwd_form">
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <p class="form-control-static" id="username_update_static">${sessionScope.user.username}</p>
    ...
    <div class="row">
        <div class="col-md-4">
                <button type="button" class="btn btn-primary btn-block" id="admin_updatePwd_btn">提交</button>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $("#admin_updatePwd_btn").click(function () {
        $("#pwdStart_update_input").next("span").text("");
        if (checkPassword()==true){
            $.ajax({
                url:"${pageContext.request.getContextPath()}/adminController/updatePwd",
                type:"POST",
