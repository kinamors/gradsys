...
<div class="layout-admin">
    <header class="layout-header">
        ...
        <ul class="header-bar">
            <li class="header-bar-role"><a href="javascript:;">学生</a></li>
            <li class="header-bar-nav">
                <a href="javascript:;">${sessionScope.user.sName}<i class="icon-font" style="margin-left:5px;">&#xe60c;</i></a>
...
<script type="text/javascript" src="${pageContext.request.getContextPath()}/static/common/js/sccl.js"></script>
