        ...
        <div class="col-xs-10 col-md-9" id="search_div">
            <form class="form-inline">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="upFileType" id="fileType_input" value="paper">
                </div>
...
<script type="text/javascript">
    ...
    function to_page(page){
        ...
        $.ajax({
            url:"${pageContext.request.getContextPath()}/upLoadRecordController/getPaperUpRecord",
            data:"page="+page,
            type:"GET",
