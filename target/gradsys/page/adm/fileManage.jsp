...
<div class="container-fluid">
        ...
        <div class="col-xs-10 col-md-9" id="search_div">
            <form class="form-inline">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="upFileType" id="fileType_input" value="">
                </div>
    ...
    <div class="row">
        <div class="col-md-12" style="height: 600px">
            <table class="table table-hover" id="UpRecord_table">
                <thead>
                <tr>
...
<script type="text/javascript">
    ...
    function to_page(page){
        ...
        $.ajax({
            url:"${pageContext.request.getContextPath()}/upLoadRecordController/getAllUpRecord",
            data:"page="+page,
            type:"GET",

            success:function(result){

                build_UpRecord_table(result);
                // console.log(result);
    ...
    //显示课题表格
    function build_UpRecord_table(result) {
        $("#UpRecord_table tbody").empty();
        if(result.code==101){
            return
        }
        ...
        $.each(reportUpRecord,function (index,item) {
            ...
            delBtn.attr("url",item.upUrl).attr("filename",item.upFilename).attr("del_id",item.upId);
            var Btns=$("<td></td>").append(downloadBtn).append(delBtn);
            $("<tr></tr>").append(countNum)
                ...
                .append(upFileType)
                .append(upTime)
                .append(Btns).appendTo("#UpRecord_table tbody");
    ...
    $(document).on("click",".del_btn",function(){
        var fName = $(this).parents("tr").find("td:eq(4)").text();
        var id = $(this).attr("del_id");
        var url = $(this).attr("url");
        var filename = $(this).attr("filename");
        if(confirm("确认删除【"+fName+"】吗")){
            $.ajax({
                url:"${pageContext.request.getContextPath()}/upLoadRecordController/deleteFile",
                data:"id="+id+"&url="+url,
                type:"POST",
                success:function(result){
                    console.log(result);
