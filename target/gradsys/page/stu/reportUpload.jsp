        ...
        <div class="col-md-6">
            <form enctype="multipart/form-data" id="uploadForm">
                <div class="form-group">
                    ...
                    <input type="hidden" name="type" id="type_input" value="report">
                </div>
            </form>
...
<script type="text/javascript">
    ...
    $("#upload_button").click(function () {
        ...
        formData.append("upUserName","${sessionScope.user.sName}");
        formData.append("upSno","${sessionScope.user.sno}");
        $.ajax({
