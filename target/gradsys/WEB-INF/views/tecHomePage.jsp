...
<div class="layout-admin">
    <header class="layout-header">
        ...
        <ul class="header-bar">
            <li class="header-bar-role"><a href="javascript:;">教师</a></li>
            <li class="header-bar-nav">
                <a href="javascript:;">${sessionScope.user.tname}<i class="icon-font" style="margin-left:5px;">&#xe60c;</i></a>
...
<script type="text/javascript" src="${pageContext.request.getContextPath()}/static/common/js/sccl-teacher.js"></script>
